...
class HotelManagementSystem:
    def __init__(self, root):
        ...
        report_btn=Button(btn_frame,text="REPORT",width=22,command=self.report,font=("times new roman", 14, "bold"), bg="black", fg="gold",bd=0,cursor="hand1")
    ...
    def logout(self):
        self.new_window=Toplevel(self.root)
        self.app=Logout(self.new_window)
